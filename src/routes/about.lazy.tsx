      ...
      <div className="flex animate-fade items-center justify-center p-1">
        <div className="grid grid-cols-1 place-items-center items-center gap-3 gap-x-7 gap-y-7 p-12 text-white leading-9 lg:grid-cols-2 lg:p-32">
          <ImgThatCanHandleItsOwnErrors
            src="https://cdn.averwhy.net/IMG_8388.jpg"
            alt="A young couple smiling at the camera"
            width="480"
            height="360"
          />
          <p>
            ...
            , C#, and GDScript (Godot). I love working with databases too,
          ...
          />
          <p>
            My first programming class was an intro to Python. We used Notepad++
            to edit our programs, and John showed us videos on{" "}
            {
              <a
                href="https://py4e.com"
                rel="noopener noreferrer"
            ...
            On most of my projects I would go above and beyond because I was
            curious how I could make my program different. Before I knew it, I
            found myself joining the Programming Club, along with some others at
          ...
          <p>
            ...
            found my calling there in a team environment- kids my age working
            towards specific goals in a very collaborative setting. I stayed in
            FIRST Robotics through covid and continued competing until I
            graduated. In order to graduate though, I needed to complete my{" "}
          ...
          <p>
            ...
            EconomyX. I began writing this bot from the ground up using{" "}
            {
              <a
