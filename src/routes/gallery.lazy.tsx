...
function Gallery() {
  ...
  function galleryLoadError(){
    if (!errorDisplayed){
      galleryErrorToast.current?.show({ severity: 'error', summary: 'Gallery Error', detail:'One or more photos failed to load. this is probably cloudflare\'s fault', life: 30000})
